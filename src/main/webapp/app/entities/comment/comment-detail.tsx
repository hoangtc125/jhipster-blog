    ...
    <Row>
      <Col md="8">
        <h2 data-cy="commentDetailsHeading">
          <Translate contentKey="blogApp.comment.detail.title">Comment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="content">
              <Translate contentKey="blogApp.comment.content">Content</Translate>
            </span>
          </dt>
          <dd>{commentEntity.content}</dd>
          <dt>
            <Translate contentKey="blogApp.comment.applicationUser">Application User</Translate>
          </dt>
          <dd>{commentEntity.applicationUser ? commentEntity.applicationUser.id : ''}</dd>
          <dt>
            <Translate contentKey="blogApp.comment.blog">Blog</Translate>
          </dt>
