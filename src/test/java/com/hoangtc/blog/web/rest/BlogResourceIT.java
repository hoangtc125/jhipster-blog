...
class BlogResourceIT {
    ...
    public static Blog createEntity(EntityManager em) {
        Blog blog = new Blog().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).content(DEFAULT_CONTENT);
        // Add required entity
        ...
        blog.setApplicationUser(applicationUser);
        return blog;
    }
    ...
    public static Blog createUpdatedEntity(EntityManager em) {
        Blog blog = new Blog().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).content(UPDATED_CONTENT);
        // Add required entity
        ApplicationUser applicationUser;
        if (TestUtil.findAll(em, ApplicationUser.class).isEmpty()) {
    ...
    void putExistingBlog() throws Exception {
        ...
        updatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).content(UPDATED_CONTENT);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).content(UPDATED_CONTENT);
